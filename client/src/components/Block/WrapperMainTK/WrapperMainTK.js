  ...
  <div className="container-fluid ct-f-sideBar">
    <div className="row r-sideBar">
      ...
      <div className="col-xs-12 col-sm-9 statistical" id="content">
        ...
        <div className="byDay">
          <span className="titleBy"><i className="fas fa-coins" />&nbsp;Thống kê theo ngày</span>
          <input className="form-control" type="date" defaultValue="2019-04-05" id="example-date-input" />
        ...
        <div className="byWeek">
          <span className="titleBy"><i className="fas fa-coins" />&nbsp;Thống kê theo tuần</span>
          <div className="container">
            <div className="row text-center wrapperRow">
              <div className="col-xs-12 col-md-4">
                <div className="wrapperBlock">
        ...
        <div className="byMonth">
          <span className="titleBy"><i className="fas fa-coins" />&nbsp;Thống kê theo tháng</span>
