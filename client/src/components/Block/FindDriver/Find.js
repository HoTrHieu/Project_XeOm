...
// >>>>>>> Stashed changes
    ...
    //         // console.log(data.taixe)
    //         console.log("so dien thoai khach hang", data )
    //     //   console.log(typeof localStorage.getItem("sodienthoaiKH"))
    //         // this.setState({
    //         //     taixe: data.taixe
    //         // })
    //     }
    ...
    // getThongTinTaiXe = (sodienthoai) =>{
    //     axios.get(`http://localhost:8080/taixe/${sodienthoai}`)
    //     .then(function (response) {
    //       // handle success
    //        console.log("thong tin",response.data)
    //     })
    ...
    render() {
        console.log("finddriver", this.state.taixe)
