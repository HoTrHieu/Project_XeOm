  ...
  render(){
    ...
    return (
        <Router>
          ...
          <Route exact path="/profile"  component={localStorage.taikhoan && this.getRole()==='TaiXe' ? Profile: Index}/>
          <Route exact path="/register"  component={RegisterPage}/>
          <Route exact path="/statistical"  component={localStorage.taikhoan ? Statistical: Index}/>
          <Route exact path="/index-admin"  component={localStorage.taikhoan && this.getRole()==='admin'? IndexAdmin: Index}/> 
          <Route exact path="/alldrivers"  component={localStorage.taikhoan && this.getRole()==='admin'? AllDrivers: Index}/> 
          <Route  exact path="/driver"  component={localStorage.taikhoan && this.getRole()==='admin'? Driver: Index}/> 
        </Router>
      );
  }
